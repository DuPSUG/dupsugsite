...
export default async function ContactPage() {
  let content = ""
  let metadata = { title: 'Contact Us', date: new Date().toISOString().split('T')[0], author: 'Unknown' }

  try {
    const filePath = path.join(process.cwd(), 'data', 'contact.md')
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="terminal-prompt mb-8">
          <span className="text-accent">Get-Content</span> -Path ./contact.md
        </div>
